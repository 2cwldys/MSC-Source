				...
				if( !stricmp(CMD_ARGV(1),"add") )
				{
					...
					if( pItem )
					{
						...
						foreach( ID, SHRT_MAX )
						{
							...
							foreach( i, pStorage->Items.size( ) ) if( pStorage->Items[i].ID == ID ) { Duplicate = true; break; }
